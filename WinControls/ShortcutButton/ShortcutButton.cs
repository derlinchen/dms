...
namespace WinControls
{
  public partial class ShortcutButton : System.Windows.Forms.Button
  {
    ...
    public Image SOver
    {
      get {
        if (_sOver == null)
          _sOver = Image.FromStream(typeof(ShortcutButton).Assembly.GetManifestResourceStream("WinControls.ShortcutButton.Resources.SB_Over.png"));
    ...
    public Image SNormal
    {
      ...
      {
        if (_sNormal == null)
          _sNormal = Image.FromStream(typeof(ShortcutButton).Assembly.GetManifestResourceStream("WinControls.ShortcutButton.Resources.SB_Normal.png"));
    ...
    public Image SBack
    {
      ...
      {
        if (_sBack == null)
          _sBack = Image.FromStream(typeof(ShortcutButton).Assembly.GetManifestResourceStream("WinControls.ShortcutButton.Resources.SB_Back.png"));
    ...
    public Image SDisable
    {
      ...
      {
        if (_sDisable == null)
          _sDisable = Image.FromStream(typeof(ShortcutButton).Assembly.GetManifestResourceStream("WinControls.ShortcutButton.Resources.SB_Disable.png"));
    ...
    public Image SClick
    {
      ...
      {
        if (_sClick == null)
          _sClick = Image.FromStream(typeof(ShortcutButton).Assembly.GetManifestResourceStream("WinControls.ShortcutButton.Resources.SB_Click.png"));
